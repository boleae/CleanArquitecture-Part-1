...
public class PrecioServiceTest 
{
    ...
    public void CalcularPrecio_Should_ReturnCorrectPrecioTotal()
    {
        ...
        var precioDetale = precioService.CalcularPrecio(vehiculo, periodo);

        //Assert

        precioDetale.PrecioTotal.Should().Be(expectedPrecioTotal);
    }

    [Fact]
    public void CalcularPrecio_Should_ReturnCorrectPrecioTotal_WheMantenimientoIsIncluded()
    {
        //Arrange
        var precio = new Moneda(10.0m, TipoMoneda.Usd);
