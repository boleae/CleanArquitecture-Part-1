    ...
    public static void SeedData(this IApplicationBuilder app)
    {
        ...
        for(var i = 0;i < 100; i++)
        {
            vehiculos.Add(new
            {
                ...
                PrecioMonto = faker.Random.Decimal(1000, 200000),
                PrecioTipoMoneda = "USD",
                PrecioMantenimiento = faker.Random.Decimal(100, 200),
                PrecioMantenimientoMoneda = "USD",
        ...
        const string sql = """
            insert into public.vehiculos(id, vin, modelo, direccion_pais, direccion_departamento, direccion_provincia, direccion_ciudad, direccion_calle, precio_monto, precio_tipo_moneda, mantenimiento_monto, mantenimiento_tipo_moneda, accesorios, fecha_ultimo_alquiler)
            values(@Id, @Vin, @Modelo, @Pais, @Departamento, @Provincia, @Ciudad, @Calle, @PrecioMonto, @PrecioTipoMoneda, @PrecioMantenimiento, @PrecioMantenimientoMoneda, @Accesorios, @FechaUltimo)
        """;
